...
public class QuizActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        list.add(new QuestionModel("Microprocessor contains", "alu", "cu", "both(A) and (B)", "None of this", "both(A) and (B)"));
        list.add(new QuestionModel("The smallest unit of storage is", "bit", "byte", "kilobyte", "megabyte", "bit"));
        list.add(new QuestionModel("Main memory is ", "volatile", "non-volatile", "both (A) and (B)", "None of this", "volatile"));
        list.add(new QuestionModel("CD-ROM is a", "Memory register", "Semiconductor memory", "Secondary memory", "None of this", "Secondary memory"));
        list.add(new QuestionModel("Microprocesser was invented in ", "1968", "1969", "1970", "1971", "1971"));
        list.add(new QuestionModel("RAM is a type of ","write only memory","read only memory","read/write memory","none of above","read/write memory"));
        list.add(new QuestionModel("whit is the file extension of texual files in windows ",".mdf",".txt",".doc","none of above",".txt"));
        list.add(new QuestionModel("The computer consists of","memory","cpu","i/o device","all of above","all of above"));
        list.add(new QuestionModel("Lowest unit of speed is","Pico second","Nano second","Micro second","Milli second","Pico second"));
        list.add(new QuestionModel("The control unit controls all ","software operations","hardware operations","both (A) and (B)","none of the above","hardware operations"));
        ...
        next_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (position ==list.size()){
                    Intent scoreintent = new Intent(QuizActivity4.this,ScoreActivity.class);
                    finish();
    ...
    public void onBackPressed() {
        Intent intent = new Intent(QuizActivity4.this,QuizActivity.class);
