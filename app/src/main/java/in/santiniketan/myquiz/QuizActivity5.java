...
public class QuizActivity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        list.add(new QuestionModel("Add,Subtract,Multiple and logic operation are performed by", "Memory", "Control unit", "ALU", "None of this", "ALU"));
        list.add(new QuestionModel("In digital computer, data is represent in", "octal form", "Hexadecimal form", "Binary form", "Numerical form", "Binary form"));
        ...
        list.add(new QuestionModel("Which of the following is a scondary memory device ?", "RAM", "Disk", "Keyboard", "Mouse", "Disk"));
        ...
        list.add(new QuestionModel("On shutdown window to start the computer, type","U","M","E","R","R"));
        list.add(new QuestionModel("The heart or the Computer is","input unit","ALU","RAM","CPU","CPU"));
        list.add(new QuestionModel("Lowest unit of speed is","Pico second","Nano second","Micro second","Milli second","Pico second"));
        list.add(new QuestionModel("Undo is Similar to","Ctrl + X","Ctrl + Z","Ctrl + U","Ctrl + C","Ctrl + Z"));
